...
def handle_unknown_disease(disease_name):
    ...
    prompt = f'For the disease "{disease_name}", provide the following details as a JSON file. Do not provide anything else. If it is not a disease, return None for all fields: {{"name": "", "introduction": "", "symptoms": ["", ""], "causes": "", "diagnosis": "", "treatment": "", "prevention": "", "pathogen_name": "", "pathogen_type": "", "gemini-reply": "true"}}'
